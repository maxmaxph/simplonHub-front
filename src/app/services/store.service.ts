...
export class StoreService {
  ...
  getCategoryImageById(categoryId: string): string {
    ...
    return (
      this.categoryImages[categoryId] || 'assets/img/img_category/default.jpg'
    ); // Si aucun match, renvoyez une image par défaut
  }
  ...
  createStore(newStore: Store): Observable<Store> {
    // On envoie le nouveau store au serveur
